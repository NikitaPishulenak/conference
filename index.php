...
//Прочие данные
    ...
    if (is_uploaded_file($_FILES['reportFile']['tmp_name'])) {
        if($_FILES['reportFile']['size']<=4*1024*1024){
            ...
            move_uploaded_file($_FILES['reportFile']['tmp_name'], "../conference/reports/$folder[0]/" . $_FILES['reportFile']['name']);
            echo "<script>alert(\"Файл успешно загружен\")</script>";
        }
        else{
            echo "<script>alert(\"Размер файла превышает 4 МБ! Загрузка на сервер не возможна!\")</script>";
            exit;
        }
...
<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
    <div id="conteiner">
        ...
        <div id="uploadFile">
            ...
            <span style="color: #8c0000; font-size: 0.9em"><i>Размер файла не должен превышать 4Mb</i></span><br>
            <input type="file" name="reportFile" id="uploadFile" accept="application/pdf" accept=".pdf" required>
        </div>
                ...
                <div id="aboutAuthor">
                    ...
                    <input type="date" name="birthdate" max="2008-01-01" min="1950-01-01" required
                           title="Введите в формате: ГГГГ-ММ-ДД" placeholder="ГГГГ-ММ-ДД"><br><br>
                    ...
                    <label><input type="radio" name="universityName" value="0" id="rbUniver1"><em class="radioNameUniver"> Другое:</em></label>
                    ...
                    <label><input type="radio" name="facultyName" value="0" id="rbFac1"><em class="radioNameUniver">Другое/Other</em></label>
                ...
                <div id="aboutAuthor2">
                    ...
                    <b> Полное название учебного заведения/организации автора (Full name of the institution which the Author
                        represent):</b><br>
                    <em class="hint">Пример (example): Белорусский государственный медицинский университет</em><br>
                    <label><input type="radio" name="universityName2" value="Белорусский государственный медицинский университет"><em
                ...
                <div id="secondAuthor">
                    ...
                    <div id="firstSupervisor">
                        ...
                        <b> Фамилия 1-го научного руководителя (Surname of the 1st Supervisor):</b><span class="req">*</span><br>
                        ...
                        <b>Учёная степень 1-го научного руководителя (Scientific degree of the 1st Supervisor)</b><span class="req">*</span><br>
                        ...
                        <b>Учёное звание 1-го научного руководителя (Academic rank of the 1st Supervisor)</b><span class="req">*</span><br>
                        ...
                        <b>Должность 1-го научного руководителя (Position of the 1st Supervisor)</b><span class="req">*</span><br>
                        ...
                        <label><input type="radio" name="universityNameSupervisor"
                               value="Белорусский государственный медицинский университет" checked><em class="radioNameUniver">
                        ...
                        <b>Название кафедры/структурного подразделения 1-го научного руководителя (Department)</b><span class="req">*</span><br>
