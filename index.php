...
<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
    <div id="conteiner">
        ...
        <div id="aboutAuthor">
            ...
            <input type="radio" name="universityName" value="0" id="rbUniver1"><em class="radioNameUniver"> Другое:</em>
            <input type="text" name="nameOtherUniversity" pattern="^[А-Я]{1}[а-яА-Я\-\s]{5,300}|[A-Z]{1}[a-zA-Z\-\s]{5,300}$" id="fullNameUniver1"> <br><br>
            ...
            <input type="radio" name="facultyName" value="0" id="rbFac1"><em class="radioNameUniver">Другое/Other</em>
            <input type="text" name="nameOtherFaculty" pattern="^[А-Я]{1}[а-яА-Я\-\s]{3,150}|[A-Z]{1}[a-zA-Z\-\s]{3,150}$" id="otherFac1" placeholder="Нейронные сети"> <br><br>
...
<!-- Информация о соавторе-->
        <h1 id="aboutAuthor2"><abbr title="Для того, чтобы свернуть блок кликните мышью!))"> Информация об соавторе (Information about the  second Author)</abbr> </h1><hr><br>
        <div id="aboutAuthor2">
            ...
            <input type="radio" name="universityName2" value="0" id="rbUniver2"><em class="radioNameUniver"> Другое:</em>
            <input type="text" name="nameOtherUniversity2" pattern="^[А-Я]{1}[а-яА-Я\-\s]{5,300}|[A-Z]{1}[a-zA-Z\-\s]{5,300}$" id="fullNameUniver2"> <br><br>
            ...
            <input type="radio" name="facultyName" value="0" id="rbFac2"><em class="radioNameUniver">Другое/Other</em>
            <input type="text" name="nameOtherFaculty2" pattern="^[А-Я]{1}[а-яА-Я\-\s]{3,150}|[A-Z]{1}[a-zA-Z\-\s]{3,150}$" id="otherFac2" placeholder="Нейронные сети"> <br><br>
        ...
        <div id="secondAuthor">
            ...
            <h3 id="firstSupervisorLabel" ><abbr title="Для того, чтобы свернуть блок кликните мышью!))">Сведения о 1-ом научном руководителе<br>
            ...
            <div id="firstSupervisor">
                ...
                <input type="radio" name="universityNameSupervisor" value="0" id="rbUniverBoss1"><em class="radioNameUniver"> Другое:</em>
                <input type="text" name="nameOtherUniversitySupervisor" pattern="^[А-Я]{1}[а-яА-Я\-\s]{5,300}|[A-Z]{1}[a-zA-Z\-\s]{5,300}$" id="UniverBoss1" title="Название должно начинаться с заглавной буквы"> <br><br>
            ...
            <h3 id="secondSupervisorLabel"><abbr title="Для того, чтобы свернуть блок кликните мышью!))">Сведения о 2-ом научном руководителе<br>
            ...
            <div id="secondSupervisor">
                ...
                <input type="radio" name="universityNameSupervisor2" value="0" id="rbUniverBoss2"><em class="radioNameUniver"> Другое:</em>
                <input type="text" name="nameOtherUniversitySupervisor2" pattern="^[А-Я]{1}[а-яА-Я\-\s]{5,300}|[A-Z]{1}[a-zA-Z\-\s]{5,300}$" id="UniverBoss2" title="Название должно начинаться с заглавной буквы"> <br><br>
