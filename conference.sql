...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 31 2016 г., 20:08
...
(23, '', '', '', 1, 1, 1, '', '', '', '', ''),
(24, 'Александр', 'Якубович', 'Дмитриевич', 8, 18, 14, 'Белорусский государственный медицинский университет', 'Терапии', 'Борисов', 'ni@dcs.qws', ''),
(25, '', '', '', 1, 1, 1, '', '', '', '', ''),
(26, 'Илья', 'Якубович', 'Петрович', 1, 1, 1, 'Белорусский государственный медицинский университет', 'Анестезии', 'Минск', 'ni@dcs.qws', ''),
(27, '', '', '', 1, 1, 1, '', '', '', '', ''),
(28, 'Илья', 'Якубович', 'Петрович', 1, 1, 1, 'Белорусский государственный медицинский университет', 'Анестезии', 'Минск', 'ni@dcs.qws', ''),
(29, '', '', '', 1, 1, 1, '', '', '', '', ''),
(30, 'Александр', 'Якубович', 'Дмитриевич', 9, 4, 1, 'Белорусский государственный медицинский университет', 'Анестезии', 'Борисов', 'ni@dcs.qws', ''),
(31, '', '', '', 1, 1, 1, '', '', '', '', ''),
(32, 'ПроверкаВторПроверкаРуководите', 'ПроверкаРуководите', 'ПроверкаРуководите', 1, 1, 1, 'Белорусский государственный медицинский университет', 'ПроверкаРуководите', 'ПроверкаРуководите', 'kon@mail.ru', '375778567734'),
(33, '', '', '', 1, 1, 1, '', '', '', '', ''),
(34, 'ПроверкаВторПроверкаРуководите', 'ПроверкаРуководите', 'ПроверкаРуководите', 1, 1, 1, 'Белорусский государственный медицинский университет', 'ПроверкаРуководите', 'ПроверкаРуководите', 'kon@mail.ru', '375778567734'),
(35, '', '', '', 1, 1, 1, '', '', '', '', '');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `email` varchar(100) NOT NULL,
  `telephone` varchar(50) NOT NULL,
  `id_firstBoss` int(11) DEFAULT NULL
...
INSERT INTO `users` (`id_user`, `firstnameUser`, `secondnameUser`, `midlenameUser`, `birthdate`, `city`, `country`, `fullNameInstitute`, `abbreviationInstitute`, `id_status`, `nameFaculti`, `id_course`, `email`, `telephone`, `id_firstBoss`) VALUES
(3, 'Никита', 'Пищуленок', '', '2000-01-01', 'Минск', 'РБ', 'мед', 'бгму', 3, '', 3, 'niki@ma.ru', '375334343', 1),
(4, 'Ник', 'Орлов', 'Алекс', '1995-09-29', 'Лепель', 'Республика Беларусь', 'Белорусский государственный медицинский университет', 'БГУИР', 1, '', 5, 'niki1995-11@mail.ru', '375336112211', 18),
(5, 'Никита', 'Пищуленок', 'Александрович', '0000-00-00', 'Минск', 'Республика Беларусь', 'Белорусский-государственный-университет-информатики-и-радиоэлектроники', 'БГУИР', 1, '', 5, 'niki@mail.ru', '+375297126743', 20),
(6, 'Анастасия', 'Якубович', 'Александровна', '1986-10-19', 'Минск', 'Республика Беларусь', 'Бел Лингв Универ', 'БГЛУ', 13, 'Иностранные дела', 7, 'anapi@mail.ru', '+375-(33)-7139925', 24),
(7, 'Анастасия', 'Орлов', 'Александровна', '2000-11-28', 'Смоленск', 'Республика Беларусь', 'Белорусский государственный медицинский университет', 'БГЛУ', 1, 'Военно-медицинский (Military Medicine)', 4, 'ec@msl.ru', '+375-(33)-611-19-23', 26),
(8, 'Анастасия', 'Орлов', 'Александровна', '2000-11-28', 'Смоленск', 'Республика Беларусь', 'Белорусский государственный медицинский университет', 'БГЛУ', 1, 'Военно-медицинский (Military Medicine)', 4, 'ec@msl.ru', '+375-(33)-611-19-23', 28),
(9, 'Анастасия', 'Якубович', 'Олегович', '2005-05-17', 'Смоленск-На-Амуре', 'Франция', 'Белорусский государственный медицинский университет', 'BSUIR', 11, 'Военно-медицинский (Military Medicine)', 1, 'proba@msl.ru', '+375-(33)-611-19-23', 30),
(10, 'Проверка', 'Проверка', 'Проверка', '1995-09-29', 'Проверка', 'Проверка', 'Белорусский государственный медицинский университет', 'ПРОВЕРКА', 1, 'Лечебный (General Medicine)', 1, 'proverka@pro.com', '+375297126743', NULL),
(11, 'ПроверкаВтор', 'ПроверкаВтор', 'ПроверкаВтор', '1990-10-10', 'ПроверкаВтор', 'ПроверкаВтор', 'Белорусский государственный медицинский университет', 'ПРОВ', 2, 'Педиатрический (Pediatrics)', 2, 'vtorprov@mail.ru', '375446547744', NULL),
(12, 'Проверка', 'Проверка', 'Проверка', '1995-09-29', 'Проверка', 'Проверка', 'Белорусский государственный медицинский университет', 'ПРОВЕРКА', 1, 'Лечебный (General Medicine)', 1, 'proverka@pro.com', '+375297126743', NULL),
(13, 'ПроверкаВтор', 'ПроверкаВтор', 'ПроверкаВтор', '1990-10-10', 'ПроверкаВтор', 'ПроверкаВтор', 'Белорусский государственный медицинский университет', 'ПРОВ', 2, 'Педиатрический (Pediatrics)', 2, 'vtorprov@mail.ru', '375446547744', NULL);
...
--
ALTER TABLE `boss`
  MODIFY `id_boss` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=36;
--
...
--
ALTER TABLE `reports`
  MODIFY `id_report` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=25;
--
